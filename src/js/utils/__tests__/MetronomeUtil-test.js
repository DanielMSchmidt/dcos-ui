...
describe("MetronomeUtil", function() {
  describe("#parseJobs", function() {
    ...
    it("throws error if the provided id  starts with a dot", function() {
      expect(function() {
        MetronomeUtil.parseJobs({ id: ".malformed.id" });
      }).toThrow();
    });

    it("throws error if the provided id ends with a dot", function() {
      expect(function() {
        MetronomeUtil.parseJobs({ id: "malformed.id." });
      }).toThrow();
    });
    ...
    it("throws error if item is not an object with id", function() {
      expect(function() {
  ...
  describe("#parseJob", function() {
    ...
    it("justs do nothing if history is undefined", function() {
